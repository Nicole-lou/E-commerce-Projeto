// O que vai ser feito: 
// 1. colocar os produtos via javascript
// colocar os prdutos na tela:
// Saber quem são os produtos - feito
// onde colocar os produtos - feito
...
// html - usamos document.querySelector - selecionar algo
...
function mostrarProdutos() {
    ...
    <button class="botao-produto">Ver Mais</button>

    </div> <!--fim div info-produto 1-->

    </div> <!--fim div cartao-produto 1-->         
...
// innerHTML = coloca o que eu quiser no HTML
 ...
 mostrarProdutos()
    ...
    // pegar item por item do meu array de forma automática, 
    // e ai eu posso
